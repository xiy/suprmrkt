...
//  $Author: xiy3x0 $
//  $Revision: 8 $
//  $Id: TaskDialog.cs 8 2008-03-02 15:54:03Z xiy3x0 $
//
...
namespace Pyramid.Garnet.Controls.Dialogs
{
  ...
  public enum TaskDialogNotification
  {
	...
	///// Occurs when a navigation message has completed (for pseudo-aero wizards).
    ///// The value returned by the callback is ignored.
    ///// </summary>   
    Navigated = 1,
  ...
  public class TaskDialog
  {
    ...
    {
      get { return new Version(6, 0, 6000); }
    }
    ...
    /// <summary>
    /// Gets or Sets the state of the progress bar between normal, paused and error states.
    /// </summary>
    ...
    {
      if ((UseCommandLinks || UseCommandLinksNoIcon) && (buttons.Length == 0))
      {
